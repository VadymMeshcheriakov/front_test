            ...
            <Content>
                ...
                props.articles.map((article, key) => (
                    <Article key={key}>
                        ...
                        <SharedImage>
                            <a>{!article.sharedImg && article.video ?
                                <ReactPlayer width={"100%"} url={article.video}/> : article.sharedImg &&
                                <img src={article.sharedImg} alt=""/>}</a>
                        </SharedImage>
                        <SocialCount>
                        ...
                        <SocialActions>
                            <button onClick={(event) => likeHandler(event, key, props.ids[key])}
